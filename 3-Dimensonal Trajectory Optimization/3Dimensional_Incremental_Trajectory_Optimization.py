...
from Load_Data_3D import edges_vertices_and_info, sensor_xyz #Import functions from Load_Data_3 to load poses, edges, info and sensor x and y coordinates from .G2O file
...
initial_x_y = sensor_xyz() #From Load_Data_3D
...
ax.set_ylim3d(0, 250)
ax.set_zlim3d(-10, 5)
plt.title("3-Dimensional Incremental Trajectory Optimization")
plt.legend()
